...
boolean Res=Boolean.parseBoolean(response.toString());
    ...
    public String getFeedbackRenewals(String OfficerCode, String PhoneNumber) throws IOException, XmlPullParserException {
        SoapObject request = new SoapObject(WSDL_TARGET_NAMESPACE,OPERATION_NAME);
	...
	public String getPayers(String OfficerCode) throws IOException, XmlPullParserException {
		SoapObject request = new SoapObject(WSDL_TARGET_NAMESPACE,OPERATION_NAME);
    ...
    public void DiscontinuePolicy(int RenewalId){
        SoapObject request = new SoapObject(WSDL_TARGET_NAMESPACE,OPERATION_NAME);
