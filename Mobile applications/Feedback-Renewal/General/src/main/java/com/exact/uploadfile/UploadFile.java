...
public class UploadFile {
	...
	public boolean uploadFileToServer(Context ctx,File file){
		...
		try {
            ...
            else if (Package.equalsIgnoreCase("com.exact.imis.feedback_renewal") && file.getName().contains("feedback"))
                UploadPath = FTPFeedbackFolder;
            else if (Package.equalsIgnoreCase("com.exact.imis.feedback_renewal") && file.getName().contains("RenPol_"))
                UploadPath = FTPPolicyRenewalFolder;
