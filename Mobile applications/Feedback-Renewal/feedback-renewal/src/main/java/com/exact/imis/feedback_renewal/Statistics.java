...
public class Statistics extends Activity {
    ...
    ArrayList<HashMap<String,String>> FeedbackStats = new ArrayList<HashMap<String, String>>();
    Global global;
    String OfficerCode,Caller;
    ...
    private void GetStatistics(){
        ...
        FeedbackStats = new ArrayList<HashMap<String, String>>();
