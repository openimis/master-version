...
Public Class Form1
    ...
    Private Sub Form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Notify = niFeedbackPrompt
        Me.niFeedbackPrompt.ShowBalloonTip(5000)
...
CHECK_AGAIN:
    ...
    Private Sub mnuExit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuExit.Click
        StopService()
        niFeedbackPrompt.Visible = False
        niFeedbackPrompt.Dispose()
        End
    End Sub
    ...
    Private Sub LoadSettings()
        ...
        XmlDoc.Load(My.Application.Info.DirectoryPath & "\ImisFeedbackPrompt.exe.config")
    ...
    Private Sub UpdateSettings()
        ...
        XmlDoc.Save(My.Application.Info.DirectoryPath & "\ImisFeedbackPrompt.exe.config")
